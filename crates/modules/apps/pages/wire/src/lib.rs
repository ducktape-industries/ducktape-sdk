...
pub const MAX_TRAVERSAL_WORK: usize = 3_500;
...
/// like every other bound the store guard enforces. a client (the MCP host,
/// the runs catalog) reads it off the wire to say what pages will accept.
